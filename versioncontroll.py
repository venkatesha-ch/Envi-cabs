...
# driversCount = 30
# assignmentTable = [0] * len(tripDetails)
# idleTimeTable = [99999] * len(tripDetails)
# DriverTrips = [0] * driversCount
...
#         string_val += tripDetails[j][1]+'_'+tripDetails[j][2]
#         endTime = startTime + Traveltimelist[string_val]
#         if(assignmentTable[j] == 0 and endtimeTracker < startTime):
#             if(endPosition != '' and endPosition != tripDetails[j][2]):
#                 sourceDest = ''
#                 sourceDest += endPosition + '_' + tripDetails[j][2]
#                 idleTime = Traveltimelist[sourceDest]
#                 if(idleTimeTable[j] > idleTime):
#                     idleTimeTable[j] = idleTime
#                     assignmentTable[j] = i+1
#             else:
#                 assignmentTable[j] = i+1
#                 idleTimeTable[j] = 0
...
# print(idleTimeTable)
# # print(DriverTrips)
# print(Traveltimelist['AREKERE_BANASWADI'])
...
#             # if(endtimeTracker + idleTime <= startTime):
#             # print(i, j, endtimeTracker , idleTime , startTime, tripDetails[j][1], tripDetails[j][2], tripDetails[j][0])
#             assignmentTable[j] = i+1
#             idleTimeTable[j] = idleTime
#             DriverTrips[i]+=1
#             endPosition = tripDetails[j][2]
...
# print("-----------")
# print(assignmentTable)
# print(Traveltimelist['BROOKEFIELD_AIRPORT'])
